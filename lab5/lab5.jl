...
# ╔═╡ eeea2f3c-9848-11ec-2df0-49a7647d9c6d
begin
	using CSV
	using DataFrames
	using StatsPlots
...
# ╔═╡ a249da7c-c868-4ecd-b3e7-dcbeecfff1a2
cooldowncsv = CSV.read("cooldown.csv", DataFrame)

# ╔═╡ 8053ebd7-f3a8-48dc-85b9-60c2f947a8ff
heatupcsv = CSV.read("heatup.csv", DataFrame)

# ╔═╡ 67ded7e1-6bb1-432d-bf1b-497a12732e62
let
	p = scatter(cooldowncsv[!,:temperature],cooldowncsv[!,:resistance], legend=:bottomright, label="Cool down", title="Resistance vs. Temperature of BSCCO sample", xlabel="Temperature (K)", ylabel="Resistance (Ohms)")
	
	scatter!(heatupcsv[!,:temperature],heatupcsv[!,:resistance], legend=:bottomright, label="Heat up")

	savefig(p, "resistancetemperature.png")
end
